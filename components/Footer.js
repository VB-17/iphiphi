        ...
        <div className="max-w-screen-lx md:mx-auto mx-6 py-10 text-center md:text-left">
          ...
          <div className="flex px-10 flex-col space-y-16 md:flex-row md:space-y-0 justify-between">
            <div className="max-w-sm ">
              ...
              <div>
                Intelligent Sensors for “AI Smart” Products. Next Generation of AI Smart Chips.
              </div>
            </div>
            <div className="">
              <h6
              ...
              <div className="mb-4 flex text-start">
                <svg
                ...
                <div className="max-w-sm">
                  C5-104, Center for Innovation and Entrepreneurship <br/> IIIT Hyderabad <br/> Telangana - 500032
                </div>
              </div>
              <div className="mb-4 flex items-center justify-center md:justify-start">
                ...
                <a href="mailto:pankaj.joshi@iphipi.com"> pankaj.joshi@iphipi.com </a>
              </div>
            </div>
          </div>
        </div>
